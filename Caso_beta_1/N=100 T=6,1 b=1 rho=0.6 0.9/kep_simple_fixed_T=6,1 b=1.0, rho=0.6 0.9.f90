program kep
    ...
    !---------------------------------------------------------------------------
    integer, parameter :: L = 800            ! Tamaño red
    
    ! Temperaturas
    real(dp), parameter :: T_left = 6.0_dp
    real(dp), parameter :: T_right = 1.0_dp
    
    ! Densidades de los reservorios
    real(dp), parameter :: rho_left = 0.6_dp
    real(dp), parameter :: rho_right = 0.9_dp
    ...
    !---------------------------------------------------------------------------
    integer(int64), parameter :: n_steps = 1000000000000_int64
    integer(int64), parameter :: relaxation_steps = 90000000000_int64
