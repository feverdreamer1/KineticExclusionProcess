...
Parameters: T_left=2.0, T_right=1.0, beta=0.0, rho_left=0.4, rho_right=0.8
"""
...
def create_combined_plots():
    ...
    fig.suptitle('KEP N constante β=0, T=4,1', 
...
def create_individual_combined_plots():
    ...
    ax1.set_xlabel('Normalized Position (x/L)', fontsize=13)
    ax1.set_ylabel('Density ρ', fontsize=13)
    ax1.set_title(f'KEP Density Profile: Simulation vs Numerical Algorithm (β = 0)', 
    ...
    ax2.set_xlabel('Normalized Position (x/L)', fontsize=13)
    ax2.set_ylabel('Temperature T', fontsize=13)
    ax2.set_title(f'KEP Temperature Profile: Simulation vs Numerical Algorithm (β = 0)', 
                 fontsize=14, fontweight='bold')
    ax2.grid(True, alpha=0.3)
    ax2.set_xlim(0, 1)
