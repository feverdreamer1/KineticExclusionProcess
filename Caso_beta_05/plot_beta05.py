...
# Base directory (parent of Plot General b=0.5)
base_dir = os.path.dirname(os.path.abspath(__file__))

# Cases for β=0.5: (folder_name, T_left, T_right, rho_left, rho_right, label)
cases = [
    ("N=100 T=2,1 b=0.5,rho=0.5 0.8", 2.0, 1.0, 0.5, 0.8, "T=2.0, ρ=0.5→0.8"),
    ("N=100 T=4,1 b=0.5, rho=0.3 0.6", 4.0, 1.0, 0.3, 0.6, "T=4.0, ρ=0.3→0.6"),
    ("N=100 T=6,1 b=0.5 rho= 0.5 0.8", 6.0, 1.0, 0.5, 0.8, "T=6.0, ρ=0.5→0.8"),
]
...
def plot_density_comparison():
    ...
    plt.tight_layout()
    plt.savefig('density_comparison_beta05.png', dpi=300, bbox_inches='tight')
    print("Saved: density_comparison_beta05.png")
    return fig
...
def plot_temperature_comparison():
    ...
    plt.tight_layout()
    plt.savefig('temperature_comparison_beta05.png', dpi=300, bbox_inches='tight')
    print("Saved: temperature_comparison_beta05.png")
    return fig

def main():
    """Main function"""
    print("=" * 60)
    print("Generando gráficas para β=0.5")
    print("=" * 60)
    ...
    print("=" * 60)
    print("\nArchivos generados:")
    print("  - density_comparison_beta05.png")
    print("  - temperature_comparison_beta05.png")
